    ...
    if (isValid) {
      try {
        ...
        const response = await axios.post('http://localhost:8080/register', {
          ...
          password,
          phoneNumber,
          roles: 'USER', // Default role is set to 'USER'
        });
      ...
      >
        ...
        >
          ...
          <TextField
            ...
            helperText={validationError.email && 'Please enter your first name.'}
          />
          <TextField
            label="Last Name"
            variant="outlined"
            ...
            onChange={(e) => setLastName(e.target.value)}
            error={validationError.email}
            helperText={validationError.email && 'Please enter your last name.'}
          />
          <TextField
            label="Username/Email"
            variant="outlined"
            ...
            onChange={(e) => setUsername(e.target.value)}
            error={validationError.email}
            helperText={validationError.email && 'Please enter a username/email.'}
          />
          <TextField
            label="Password"
            variant="outlined"
